...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: Icw6OCd19wm/css
...
export type PlasmicTextInput__VariantsArgs = {
  ...
  shadowFar?: SingleBooleanChoiceArg<"shadowFar">;
};
    ...
    <div
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootshadowFar]: hasVariant(variants, "shadowFar", "shadowFar"),
    ...
    >
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__nnPke)}
                role={"img"}
              />
            ),
      ...
      <input
        ...
        className={classNames(projectcss.all, projectcss.input, sty.input, {
          ...
          [sty.inputshadowFar]: hasVariant(variants, "shadowFar", "shadowFar"),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__yk9Ox)}
                role={"img"}
              />
            ),
