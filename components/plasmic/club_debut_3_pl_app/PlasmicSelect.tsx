...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: 4lSZ00fGYuZ/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: DitIOB-YbI8/css
      ...
      >
        ...
        >
          {true ? (
            <div
              ...
              className={classNames(projectcss.all, sty.freeBox, {
                [sty.freeBoxisOpen]: hasVariant(variants, "isOpen", "isOpen")
              })}
            >
              <BusinessIconIcon
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <MaskIcon
                className={classNames(projectcss.all, sty.svg__zclJq)}
                role={"img"}
              />
            ),
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__uvOie)}
            textValue={"Company A" as const}
            value={"value1" as const}
          >
            <div
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option___462Go)}
            textValue={"CompanyB" as const}
            value={"value2" as const}
          >
            {"Option"}
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option___7ItP0)}
            value={"value3" as const}
          >
            {"Option"}
          </Select__Option>
...
const PlasmicDescendants = {
  ...
  trigger: ["trigger", "freeBox", "svg", "contentContainer"],
  freeBox: ["freeBox", "svg"],
  svg: ["svg"],
