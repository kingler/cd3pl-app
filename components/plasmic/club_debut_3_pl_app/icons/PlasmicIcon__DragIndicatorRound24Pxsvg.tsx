...
export type DragIndicatorRound24PxsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function DragIndicatorRound24PxsvgIcon(
  props: DragIndicatorRound24PxsvgIconProps
) {
...
export default DragIndicatorRound24PxsvgIcon;
/* prettier-ignore-end */
