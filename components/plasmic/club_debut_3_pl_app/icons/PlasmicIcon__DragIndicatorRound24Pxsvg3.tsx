...
export type DragIndicatorRound24Pxsvg3IconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function DragIndicatorRound24Pxsvg3Icon(
  props: DragIndicatorRound24Pxsvg3IconProps
) {
...
export default DragIndicatorRound24Pxsvg3Icon;
/* prettier-ignore-end */
