...
export type ShopiconMonoAdd4IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function ShopiconMonoAdd4Icon(props: ShopiconMonoAdd4IconProps) {
...
export default ShopiconMonoAdd4Icon;
/* prettier-ignore-end */
