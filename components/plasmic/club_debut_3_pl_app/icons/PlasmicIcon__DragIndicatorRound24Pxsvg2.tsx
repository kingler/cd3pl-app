...
export type DragIndicatorRound24Pxsvg2IconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function DragIndicatorRound24Pxsvg2Icon(
  props: DragIndicatorRound24Pxsvg2IconProps
) {
...
export default DragIndicatorRound24Pxsvg2Icon;
/* prettier-ignore-end */
