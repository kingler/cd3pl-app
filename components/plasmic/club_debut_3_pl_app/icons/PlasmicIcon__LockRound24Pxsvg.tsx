...
export type LockRound24PxsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function LockRound24PxsvgIcon(props: LockRound24PxsvgIconProps) {
...
export default LockRound24PxsvgIcon;
/* prettier-ignore-end */
