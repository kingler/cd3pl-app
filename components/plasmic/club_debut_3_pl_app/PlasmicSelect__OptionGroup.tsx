...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: eyHaWC-7AlR/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___1Llhn)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__mWsUx)}
              />
            </React.Fragment>
          ),
          value: args.children
