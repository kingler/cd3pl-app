...
import sty from "./PlasmicSelect__Overlay.module.css"; // plasmic-import: 4lSZ00fGYuZ/css
...
function PlasmicSelect__Overlay__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        {(hasVariant(variants, "relativePlacement", "right") ? true : true) ? (
          <div
